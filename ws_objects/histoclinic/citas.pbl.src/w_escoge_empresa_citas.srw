$PBExportHeader$w_escoge_empresa_citas.srw
forward
global type w_escoge_empresa_citas from window
end type
type pb_2 from picturebutton within w_escoge_empresa_citas
end type
type pb_1 from picturebutton within w_escoge_empresa_citas
end type
type mle_1 from multilineedit within w_escoge_empresa_citas
end type
type dw_1 from datawindow within w_escoge_empresa_citas
end type
end forward
...
global w_escoge_empresa_citas w_escoge_empresa_citas

type variables
st_busca_emp_capit pa_emp
end variables

on w_escoge_empresa_citas.create
...
on w_escoge_empresa_citas.destroy
destroy(this.pb_2)
destroy(this.pb_1)
destroy(this.mle_1)
destroy(this.dw_1)
...
integer taborder = 10
string title = "none"
string dataobject = "dw_empresa_cont_citas"
...
pa_emp.desemp=dw_1.getitemstring(row,'desemp')
pa_emp.descon=dw_1.getitemstring(row,'descontrato')
closewithreturn(parent,pa_emp)
end event
