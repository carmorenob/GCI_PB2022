...
type mle_1 from multilineedit within w_hora_bas
end type
...
type cb_guarda from commandbutton within w_hora_bas
end type
type cb_2 from commandbutton within w_hora_bas
end type
type cb_1 from commandbutton within w_hora_bas
end type
...
string text = "Arme el horario sugerido seleccionando con el ratón sobre los recuadros o presionando sobre la etiquetas de los días o sobre el boton gris que se encuentra al lado de la hora.         Luego presione ~'Ocupar~' y luego guardar"
...
integer taborder = 20
string title = "none"
string dataobject = "dw_dist_hora_prof_citas"
boolean livescroll = true
borderstyle borderstyle = stylelowered!
end type
	...
	for i = 1 to this.rowcount()
		...
		do while horaini < horafin
			...
			if donde= 0 then
				...
				em_1.text=string(relativetime(time("00:00"),this.getitemnumber(1,"mayor")))
