...
idt_ah=datetime(today(),now())
idt_ah90d=datetime(relativedate(date(idt_ah),- st_os.dias_orden),time(00,00,09))

dw_1.Retrieve(tipdoc,docu,st_os.grupo,idt_ah90d,idt_ah)
