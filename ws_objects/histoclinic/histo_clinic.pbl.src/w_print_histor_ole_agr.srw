$PBExportHeader$w_print_histor_ole_agr.srw
forward
global type w_print_histor_ole_agr from window
end type
type dw_3 from datawindow within w_print_histor_ole_agr
end type
type pb_3 from picturebutton within w_print_histor_ole_agr
end type
type ddlb_archivos from dropdownlistbox within w_print_histor_ole_agr
end type
type barra from hprogressbar within w_print_histor_ole_agr
end type
type rb_2 from radiobutton within w_print_histor_ole_agr
end type
type rb_comp from radiobutton within w_print_histor_ole_agr
end type
type ddl_tipo from dropdownlistbox within w_print_histor_ole_agr
end type
type gb_1 from groupbox within w_print_histor_ole_agr
end type
type pb_1 from picturebutton within w_print_histor_ole_agr
end type
type pb_2 from picturebutton within w_print_histor_ole_agr
end type
type dw_2 from datawindow within w_print_histor_ole_agr
end type
type dw_1 from datawindow within w_print_histor_ole_agr
end type
type rte_1 from richtextedit within w_print_histor_ole_agr
end type
end forward
...
global w_print_histor_ole_agr w_print_histor_ole_agr
...
string ped_ing,paci,ls_imp,l_ruta,ls_path='C:\windows\temp\'
...
on w_print_histor_ole_agr.create
...
on w_print_histor_ole_agr.destroy
destroy(this.dw_3)
destroy(this.pb_3)
...
blob notas
string l_temporal="C:\windows\temp\"+tipdoc+docu+".jpg"
