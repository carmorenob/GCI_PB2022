$PBExportHeader$w_captur_rip_fac.srw
forward
global type w_captur_rip_fac from window
end type
type pb_1 from picturebutton within w_captur_rip_fac
end type
type st_fact from statictext within w_captur_rip_fac
end type
type s_fact from statictext within w_captur_rip_fac
end type
type dw_2 from datawindow within w_captur_rip_fac
end type
type st_edad from statictext within w_captur_rip_fac
end type
type st_sex from statictext within w_captur_rip_fac
end type
type s_edad from statictext within w_captur_rip_fac
end type
type s_sex from statictext within w_captur_rip_fac
end type
type st_docu from statictext within w_captur_rip_fac
end type
type s_doc from statictext within w_captur_rip_fac
end type
type s_pac from statictext within w_captur_rip_fac
end type
type st_paci from statictext within w_captur_rip_fac
end type
type cb_registra from picturebutton within w_captur_rip_fac
end type
type dw_trae from datawindow within w_captur_rip_fac
end type
type st_2 from statictext within w_captur_rip_fac
end type
type cbx_replica from checkbox within w_captur_rip_fac
end type
type sle_5 from singlelineedit within w_captur_rip_fac
end type
type sle_3 from singlelineedit within w_captur_rip_fac
end type
type sle_2 from singlelineedit within w_captur_rip_fac
end type
type sle_1 from singlelineedit within w_captur_rip_fac
end type
type gb_4 from groupbox within w_captur_rip_fac
end type
type gb_3 from groupbox within w_captur_rip_fac
end type
type cb_guarda from picturebutton within w_captur_rip_fac
end type
type st_1 from statictext within w_captur_rip_fac
end type
type rb_anul from radiobutton within w_captur_rip_fac
end type
type rb_incomp from radiobutton within w_captur_rip_fac
end type
type rb_comp from radiobutton within w_captur_rip_fac
end type
type rb_tod from radiobutton within w_captur_rip_fac
end type
type dw_rias from datawindow within w_captur_rip_fac
end type
type sle_4 from singlelineedit within w_captur_rip_fac
end type
type gb_1 from groupbox within w_captur_rip_fac
end type
type gb_2 from groupbox within w_captur_rip_fac
end type
end forward
...
global w_captur_rip_fac w_captur_rip_fac
...
string cemp,ccontrato,tdocu,docum,clugar_fac,clug_soat,clug_cita,tipo_fac
...
boolean enabled = false
string title = "none"
string dataobject = "dw_factu_sin_rip_nro"
...
choose case colum
	...
	case 13, 15, 17, 33, 35, 37
		if cbx_replica.checked then
			for l_i=1 to this.rowcount()
				if l_i<>row and not isnull(this.getitemstring(l_i,"r_"+mid(dwo.name,3))) and this.getitemstring(l_i,"r_"+mid(dwo.name,3))='1' then					
					if isnull(this.getitemstring(l_i,string(dwo.name))) then
						if (this.getitemstring(l_i,'s_fin_consulta') >='01' and this.getitemstring(l_i,'s_fin_consulta') <= '08') then 
						...
						if  (colum =13 or colum=15 or colum=17) then 
							...
							if veri=-1 then
								this.setitem(row,dwo.name,nulo)
								return 1
							end if
						end if
					end if
...
string cod,encuentra,ojo,este,col
long colum,veri
st_return_diags st
...
long cual
cual=this.getrow()
sex_busca=this.getitemstring(cual,"sexo")
...
st_sex.text=this.getitemstring(cual,"sexo")
