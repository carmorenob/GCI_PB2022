$PBExportHeader$w_instrumentos_hc.srw
forward
global type w_instrumentos_hc from window
end type
type dw_calc_edad from datawindow within w_instrumentos_hc
end type
type pb_1 from picturebutton within w_instrumentos_hc
end type
type pb_cancelar from picturebutton within w_instrumentos_hc
end type
type dw_1 from datawindow within w_instrumentos_hc
end type
end forward
...
global w_instrumentos_hc w_instrumentos_hc
...
title='Instrumento '+des_ins
dw_1.DataObject =dataw
...
integer height = 1428
integer taborder = 10
string dataobject = "dw_indice_brody"
