$PBExportHeader$w_plants_rtf_campos_new.srw
forward
global type w_plants_rtf_campos_new from window
end type
type t1 from tab within w_plants_rtf_campos_new
end type
type tp1 from userobject within t1
end type
type mle_1 from multilineedit within tp1
end type
...
type mle_2 from multilineedit within tp2
end type
...
type st_4 from statictext within w_plants_rtf_campos_new
end type
end forward
...
global w_plants_rtf_campos_new w_plants_rtf_campos_new
...
on w_plants_rtf_campos_new.create
this.t1=create t1
...
on w_plants_rtf_campos_new.destroy
destroy(this.t1)
destroy(this.st_4)
end on
...
event rowfocuschanged;//f_rowfocuschanged(this,mle_1,dw_campo)
end event
