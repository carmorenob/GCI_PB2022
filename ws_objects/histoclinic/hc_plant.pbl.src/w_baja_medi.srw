$PBExportHeader$w_baja_medi.srw
forward
global type w_baja_medi from window
end type
type dw_2 from datawindow within w_baja_medi
end type
type st_2 from statictext within w_baja_medi
end type
type pb_cancel from picturebutton within w_baja_medi
end type
type pb_ok from picturebutton within w_baja_medi
end type
type st_1 from statictext within w_baja_medi
end type
type st_esp from statictext within w_baja_medi
end type
type dw_1 from datawindow within w_baja_medi
end type
end forward
...
string title = "Medicamentos Anestesicos"
...
global w_baja_medi w_baja_medi

type variables
st_xa_procs_hc i_st
end variables

on w_baja_medi.create
