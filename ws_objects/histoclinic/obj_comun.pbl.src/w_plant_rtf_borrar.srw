$PBExportHeader$w_plant_rtf_borrar.srw
forward
global type w_plant_rtf_borrar from window
end type
type st_7 from statictext within w_plant_rtf_borrar
end type
type rb_allwindow from radiobutton within w_plant_rtf_borrar
end type
type rb_window from radiobutton within w_plant_rtf_borrar
end type
type tab_1 from tab within w_plant_rtf_borrar
end type
...
type gb_2 from groupbox within w_plant_rtf_borrar
end type
end forward
...
global w_plant_rtf_borrar w_plant_rtf_borrar
