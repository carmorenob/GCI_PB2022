$PBExportHeader$w_busca_cuenta.srw
forward
global type w_busca_cuenta from window
end type
type pb_1 from picturebutton within w_busca_cuenta
end type
type dw_2 from datawindow within w_busca_cuenta
end type
type dw_1 from datawindow within w_busca_cuenta
end type
type dw_opc from datawindow within w_busca_cuenta
end type
end forward
...
string title = "Contabilidad - Busca Cuenta Contable"
...
global w_busca_cuenta w_busca_cuenta
...
integer taborder = 10
string title = "none"
string dataobject = "dw_lista_plan"
...
if getitemstring(getrow(),"movimiento")<>'1' then return
