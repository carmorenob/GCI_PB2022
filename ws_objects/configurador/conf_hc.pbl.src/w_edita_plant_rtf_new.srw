$PBExportHeader$w_edita_plant_rtf_new.srw
forward
global type w_edita_plant_rtf_new from window
end type
type mle_1 from multilineedit within w_edita_plant_rtf_new
end type
type st_6 from statictext within w_edita_plant_rtf_new
end type
type pb_4 from picturebutton within w_edita_plant_rtf_new
end type
type pb_3 from picturebutton within w_edita_plant_rtf_new
end type
type pb_2 from picturebutton within w_edita_plant_rtf_new
end type
type st_5 from statictext within w_edita_plant_rtf_new
end type
type dw_newcampo from datawindow within w_edita_plant_rtf_new
end type
type pb_save from picturebutton within w_edita_plant_rtf_new
end type
type pb_7 from picturebutton within w_edita_plant_rtf_new
end type
type pb_6 from picturebutton within w_edita_plant_rtf_new
end type
type st_4 from statictext within w_edita_plant_rtf_new
end type
type dw_newplant from datawindow within w_edita_plant_rtf_new
end type
end forward
...
global w_edita_plant_rtf_new w_edita_plant_rtf_new
...
on w_edita_plant_rtf_new.create
...
on w_edita_plant_rtf_new.destroy
destroy(this.mle_1)
destroy(this.st_6)
destroy(this.pb_4)
destroy(this.pb_3)
...
event constructor;Alignment = Justify!
end event
