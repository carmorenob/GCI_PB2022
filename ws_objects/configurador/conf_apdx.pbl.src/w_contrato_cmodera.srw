$PBExportHeader$w_contrato_cmodera.srw
forward
global type w_contrato_cmodera from window
end type
type pb_1 from picturebutton within w_contrato_cmodera
end type
type pb_2 from picturebutton within w_contrato_cmodera
end type
type pb_4 from picturebutton within w_contrato_cmodera
end type
type pb_3 from picturebutton within w_contrato_cmodera
end type
type st_2 from statictext within w_contrato_cmodera
end type
type st_1 from statictext within w_contrato_cmodera
end type
type dw_1 from datawindow within w_contrato_cmodera
end type
type gb_1 from groupbox within w_contrato_cmodera
end type
end forward
...
global w_contrato_cmodera w_contrato_cmodera

on w_contrato_cmodera.create
...
long textcolor = 8388608
long backcolor = 67108864
string text = "Cuotas Moderadoras"
boolean focusrectangle = false
end type
...
integer taborder = 10
string title = "none"
string dataobject = "dw_contrato_cmodera"
...
string facename = "Arial"
long backcolor = 67108864
string text = "Cuotas Moderadoras por Estrato:"
