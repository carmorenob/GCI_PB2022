...
type pb_grabar from w_center`pb_grabar within w_rte_replace
end type
...
string text = "Diferencia Mayusculas"
end type
...
long textcolor = 33554432
long backcolor = 67108864
string text = "Palabras completas"
end type
...
Do While li_Loc > 0
	If irte_1.SelectedLength() > 0 And &
		...
		li_Changes++
	Else
		MessageBox("Remplazar", "Este es el fin.   La busqueda pudo haber fallado!!!")
		Exit
	End If
	li_Loc = irte_1.findnext()
Loop
...
If li_Changes > 0 Then
	MessageBox("Remplazar", String(li_Changes) + " remplazos hechos.")
Else
	MessageBox("Replazar", "No realizado el remplazo.")
End If
