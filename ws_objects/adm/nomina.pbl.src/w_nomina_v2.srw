$PBExportHeader$w_nomina_v2.srw
forward
global type w_nomina_v2 from w_center
end type
type pb_anular from picturebutton within w_nomina_v2
end type
type pb_cancelar from picturebutton within w_nomina_v2
end type
type pb_2 from picturebutton within w_nomina_v2
end type
type cb_1 from commandbutton within w_nomina_v2
end type
type cbx_1 from checkbox within w_nomina_v2
end type
type hpb_1 from hprogressbar within w_nomina_v2
end type
type dw_apemp from datawindow within w_nomina_v2
end type
type sle_fila from singlelineedit within w_nomina_v2
end type
type tab_1 from tab within w_nomina_v2
end type
...
type dw_tsup from datawindow within w_nomina_v2
end type
type dw_1 from datawindow within w_nomina_v2
end type
type dw_tipoincap from datawindow within w_nomina_v2
end type
type tab_n from tab within w_nomina_v2
end type
...
type st_15 from statictext within w_nomina_v2
end type
type mle_1 from multilineedit within w_nomina_v2
end type
type sle_4 from singlelineedit within w_nomina_v2
end type
type pb_calcula from picturebutton within w_nomina_v2
end type
type dw_historia_bak from datawindow within w_nomina_v2
end type
type dw_ausend from datawindow within w_nomina_v2
end type
type st_14 from statictext within w_nomina_v2
end type
type st_16 from statictext within w_nomina_v2
end type
type pb_pila from picturebutton within w_nomina_v2
end type
type dw_nelec from uo_datawindow within w_nomina_v2
end type
type lb_1 from listbox within w_nomina_v2
end type
type dw_pila from datawindow within w_nomina_v2
end type
type pb_9 from picturebutton within w_nomina_v2
end type
type dw_empact from datawindow within w_nomina_v2
end type
type dw_aus from datawindow within w_nomina_v2
end type
end forward
...
global w_nomina_v2 w_nomina_v2

type variables
uo_dataStore dw_conceptos, dw_contra, dw_concep_cargo
long periodo, il_nuevo, borrar, vac, lm, ln, ctrl,lp,l_sus,l_inc,l_incp,l_perm,l_luto
...
uo_datastore dw_historia , ids_req , ids_novedad, dw_histoall, dw_aus_all, dw_presta_all, dw_prestaact, dw_tsup_all
...
Return vac + l_inc+ l_incp + lm + ln + lp + l_sus + l_luto
...
Return vac + l_inc + l_incp + lm + ln +lp +l_luto
...
public function integer datos_ausentismo (string tipodoc, string documento, string cod_ausentismo);
dw_aus.reset()
dw_aus_all.setFilter("tipodoc = '" + tipodoc + "' AND documento = '" + documento + "' AND cod_ausen ='" + cod_ausentismo + "'")
dw_aus_all.filter()
dw_aus.sort()

dw_aus_all.rowsCopy(1, dw_aus_all.rowCount(), primary!, dw_aus, 0, primary!)
...
public function integer datos_prestamos (string tipodoc, string documento);
dw_prestaact.reset()
dw_presta_all.setFilter("tipodoc = '" + tipodoc + "' AND documento = '" + documento + "'")
dw_presta_all.filter()
dw_presta_all.sort()

dw_presta_all.rowsCopy(1, dw_presta_all.rowCount(), primary!, dw_prestaact, 0, primary!)
...
public function integer datos_tsuplementario (string tipodoc, string documento);
dw_tsup.reset()
dw_tsup_all.setFilter("tipodoc = '" + tipodoc + "' and documento = '" + documento + "'")
dw_tsup_all.filter()
dw_tsup_all.rowsCopy(1, dw_tsup_all.rowCount(), primary!, dw_tsup, 0, primary!)

return dw_tsup.rowCount()
end function

on w_nomina_v2.create
int iCurrent
call super::create
...
this.Control[iCurrent+18]=this.dw_historia_bak
this.Control[iCurrent+19]=this.dw_ausend
this.Control[iCurrent+20]=this.st_14
this.Control[iCurrent+21]=this.st_16
this.Control[iCurrent+22]=this.pb_pila
this.Control[iCurrent+23]=this.dw_nelec
this.Control[iCurrent+24]=this.lb_1
this.Control[iCurrent+25]=this.dw_pila
this.Control[iCurrent+26]=this.pb_9
this.Control[iCurrent+27]=this.dw_empact
this.Control[iCurrent+28]=this.dw_aus
end on

on w_nomina_v2.destroy
call super::destroy
...
type pb_grabar from w_center`pb_grabar within w_nomina_v2
integer x = 3968
integer y = 24
...
//// Trae datos de todos los empleados
dw_histoall.retrieve(l_nesp,l_tnom)
dw_aus_all.Retrieve(tab_n.tpn_1.dw_nomcab.GetItemDateTime(tab_n.tpn_1.dw_nomcab.GetRow(),'inicia'), tab_n.tpn_1.dw_nomcab.GetItemDateTime(tab_n.tpn_1.dw_nomcab.GetRow(),'termina'))
dw_presta_all.retrieve(tab_n.tpn_1.dw_nomcab.GetItemDateTime(tab_n.tpn_1.dw_nomcab.GetRow(),'inicia'), tab_n.tpn_1.dw_nomcab.GetItemDateTime(tab_n.tpn_1.dw_nomcab.GetRow(),'termina'))
dw_tsup_all.retrieve( year(date(tab_n.tpn_1.dw_nomcab.GetItemDateTime(tab_n.tpn_1.dw_nomcab.Getrow(),'inicia'))),month(date(tab_n.tpn_1.dw_nomcab.GetItemDateTime(tab_n.tpn_1.dw_nomcab.Getrow(),'inicia'))) )
////
