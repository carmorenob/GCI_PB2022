...
for ld_j = 1 to tab_2.t2.dw_2.rowCount()
	if tab_2.t2.dw_2.getItemNumber(ld_j, 'a_usar') > 0 then
		...
		if ld_fila=0 then
			...
			st_ord.dw_intfaz.setItem(ld_fila, 'char_orig1', tab_2.t2.dw_2.getItemString(ld_j, "coddoc"))
			st_ord.dw_intfaz.setItem(ld_fila, 'char_orig2', tab_2.t2.dw_2.getItemString(ld_j, "clugar"))
			...
			st_ord.dw_intfaz.setItem(ld_fila, 'num_orig2',st_ord.ld_fila)
