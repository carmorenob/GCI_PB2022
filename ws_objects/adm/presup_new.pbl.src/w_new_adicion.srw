$PBExportHeader$w_new_adicion.srw
forward
global type w_new_adicion from w_docum_base1
end type
end forward

global type w_new_adicion from w_docum_base1
string tag = "Modificó una adición, desea guardar los cambios ?"
string title = "Presupuesto - Adiciones"
string icon = "ribon_adccionp.ico"
string i_ing_gasto1 = "0"
string i_ing_gasto2 = "1"
string i_cdoc = "PPA"
string i_desdoc = "Adición Presupuestal"
end type
global w_new_adicion w_new_adicion
...
return grabar_def_1('monto_adicion',1)
end function
...
on w_new_adicion.create
call super::create
end on

on w_new_adicion.destroy
call super::destroy
end on
...
type tab_1 from w_docum_base1`tab_1 within w_new_adicion
end type
...
type cbx_1 from w_docum_base1`cbx_1 within w_new_adicion
end type

type dw_movi from w_docum_base1`dw_movi within w_new_adicion
end type

type pb_find from w_docum_base1`pb_find within w_new_adicion
end type

type tb_1 from w_docum_base1`tb_1 within w_new_adicion
end type
...
type pb_print from w_docum_base1`pb_print within w_new_adicion
end type

type pb_save_def from w_docum_base1`pb_save_def within w_new_adicion
end type

type pb_anula from w_docum_base1`pb_anula within w_new_adicion
end type

type pb_save from w_docum_base1`pb_save within w_new_adicion
end type

type pb_new from w_docum_base1`pb_new within w_new_adicion
boolean originalsize = false
end type

type st_1 from w_docum_base1`st_1 within w_new_adicion
end type

type dw_historial from w_docum_base1`dw_historial within w_new_adicion
end type

type dw_vig_per from w_docum_base1`dw_vig_per within w_new_adicion
end type

type gb_1 from w_docum_base1`gb_1 within w_new_adicion
end type

type dw_cab from w_docum_base1`dw_cab within w_new_adicion
end type

event dw_cab::itemchanged;call super::itemchanged;i_cambio=true
end event

type dw_cont from w_docum_base1`dw_cont within w_new_adicion
end type
