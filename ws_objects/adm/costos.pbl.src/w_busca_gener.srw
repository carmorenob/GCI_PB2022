...
if isvalid(i_dw) then
	i_dw.setitem(i_dw.getrow(),'edita',dw_1.getitemstring(dw_1.getrow(),'c_medica'))
	i_dw.event itemchanged(i_dw.getrow(),i_dw.object.edita,dw_1.getitemstring(dw_1.getrow(),'c_medica'))
else
