...
type variables
string proced, f_grupo,f_subgrp,f_categ,f_todos,f_tincluye,escog,tipoingres
end variables
...
event open;proced=left(message.stringparm , pos(message.stringparm,"-") -1)
tipoingres=right(message.stringparm , len(message.stringparm) -pos(message.stringparm,"-") )
escog="!"
...
dw_cc.retrieve(f_grupo,f_subgrp,f_categ,proced,tipoingres)
